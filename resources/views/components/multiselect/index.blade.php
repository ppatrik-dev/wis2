...
<div>
    ...
    <button id="dropdownMenuButton" data-dropdown-toggle="dropdownMenu"  
        class="relative w-full px-3 py-4.5 text-gray-500 dark:text-gray-400 border border-gray-300 rounded-lg
                bg-gray-50 text-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 
                    dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" type="button">
        
        <svg class="absolute right-3 top-1/2 -translate-y-1/2 w-2.5 h-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
