...
use Modules\Course\Policies\CourseNewsPolicy;
use Modules\Course\Policies\CourseStudentPolicy;
use Modules\Course\Policies\CourseLecturerPolicy;
...
class CourseServiceProvider extends ServiceProvider {
    ...
    protected array $policies = [
        ...
        CourseNews::class => CourseNewsPolicy::class,
        CourseStudent::class => CourseStudentPolicy::class,
        CourseLecturer::class => CourseLecturerPolicy::class
    ];
    ...
    public function boot(): void {
        ...
        Gate::define('course.viewStudents', [CoursePolicy::class, 'viewStudents']);
        Gate::define('course.viewLecturers', [CoursePolicy::class, 'viewLecturers']);
        Gate::define('course.viewNews', [CoursePolicy::class, 'viewNews']);
        Gate::define('course.viewMyCourse', [CoursePolicy::class, 'viewMyCourse']);
