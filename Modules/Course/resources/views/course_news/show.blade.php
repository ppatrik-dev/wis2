<x-course::layouts.master>
    ...
    <x-course::profile :courseNews="$courseNews">
        <form id="newsDeleteForm" action="{{ route('course.news.destroy', [$courseId, $courseNews->id]) }}" method="POST" class="w-full max-w-3/4 mx-auto py-10 grid grid-cols-3 gap-6"
