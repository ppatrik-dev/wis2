        ...
        <tbody>
            @if(isset($courses))
                ...
                <tr class="bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                    ...
                    <td class="px-6 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white"> <a href="{{ route('course.show', $course->id) }}">{{ $course->code }}</a></td>
                    ...
                    <td class="inline-flex px-6 py-3">
                        <a href="{{ route('course.edit', $course->id) }}" class="font-medium text-blue-600 ms-3 dark:text-blue-500 hover:underline" title="Edit">
                            <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                <path fill-rule="evenodd" d="M5 8a4 4 0 1 1 7.796 1.263l-2.533 2.534A4 4 0 0 1 5 8Zm4.06 5H7a4 4 0 0 0-4 4v1a2 2 0 0 0 2 2h2.172a2.999 2.999 0 0 1-.114-1.588l.674-3.372a3 3 0 0 1 .82-1.533L9.06 13Zm9.032-5a2.907 2.907 0 0 0-2.056.852L9.967 14.92a1 1 0 0 0-.273.51l-.675 3.373a1 1 0 0 0 1.177 1.177l3.372-.675a1 1 0 0 0 .511-.273l6.07-6.07a2.91 2.91 0 0 0-.944-4.742A2.907 2.907 0 0 0 18.092 8Z" clip-rule="evenodd"/>
                            </svg>
                        </a>
                        <a href="{{ route('course.student.index', $course->id) }}" class="font-medium text-blue-600 ms-3 dark:text-blue-500 hover:underline" title="Students">
                            <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M12 12a5 5 0 1 0-5-5 5 5 0 0 0 5 5Zm-9 9a9 9 0 0 1 18 0v1H3Z"/>
                            </svg>
                        </a>
                        <a href="{{ route('course.lecturer.index', $course->id) }}" class="font-medium text-blue-600 ms-3 dark:text-blue-500 hover:underline" title="Lecturers">
                            <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M7 12a5 5 0 1 0-5-5 5 5 0 0 0 5 5Zm10-2h2a2 2 0 0 1 2 2v10h-2V12h-2v10h-2V12a2 2 0 0 1 2-2Z"/>
                            </svg>
                        </a>
                        <a href="{{ route('course.news.index', $course->id) }}" class="font-medium text-blue-600 ms-3 dark:text-blue-500 hover:underline" title="News">
                            <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            ...
            @elseif(isset($courseStudents))
                ...
                <tr class="bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                    ...
                    <td class="inline-flex px-6 py-3">
                        ...
                        <a href="{{ route('course.student.edit', [$courseId, $student->id]) }}" class="font-medium text-blue-600 ms-3 dark:text-blue-500 hover:underline" title="Edit">
                            <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                <path fill-rule="evenodd" d="M5 8a4 4 0 1 1 7.796 1.263l-2.533 2.534A4 4 0 0 1 5 8Zm4.06 5H7a4 4 0 0 0-4 4v1a2 2 0 0 0 2 2h2.172a2.999 2.999 0 0 1-.114-1.588l.674-3.372a3 3 0 0 1 .82-1.533L9.06 13Zm9.032-5a2.907 2.907 0 0 0-2.056.852L9.967 14.92a1 1 0 0 0-.273.51l-.675 3.373a1 1 0 0 0 1.177 1.177l3.372-.675a1 1 0 0 0 .511-.273l6.07-6.07a2.91 2.91 0 0 0-.944-4.742A2.907 2.907 0 0 0 18.092 8Z" clip-rule="evenodd"/>
                            </svg>
                        </a>
            ...
            @elseif(isset($courseLecturers))
                ...
                <tr class="bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                    ...
                    <td class="px-6 py-3">     <a href="{{ route('course.lecturer.show', [$courseId, $lecturer->id]) }}">{{ $lecturer->pivot->role }}     </a></td>
                    <td class="px-6 py-3">{{ $lecturer->pivot->created_at ? $lecturer->pivot->created_at->format('d-m-Y') : 'N/A' }}</td>
                    <td class="inline-flex px-6 py-3">

                        <a href="{{ route('course.lecturer.edit', [$courseId, $lecturer->id]) }}" class="font-medium text-blue-600 ms-3 dark:text-blue-500 hover:underline" title="Edit">
                            <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                <path fill-rule="evenodd" d="M5 8a4 4 0 1 1 7.796 1.263l-2.533 2.534A4 4 0 0 1 5 8Zm4.06 5H7a4 4 0 0 0-4 4v1a2 2 0 0 0 2 2h2.172a2.999 2.999 0 0 1-.114-1.588l.674-3.372a3 3 0 0 1 .82-1.533L9.06 13Zm9.032-5a2.907 2.907 0 0 0-2.056.852L9.967 14.92a1 1 0 0 0-.273.51l-.675 3.373a1 1 0 0 0 1.177 1.177l3.372-.675a1 1 0 0 0 .511-.273l6.07-6.07a2.91 2.91 0 0 0-.944-4.742A2.907 2.907 0 0 0 18.092 8Z" clip-rule="evenodd"/>
                            </svg>
                        </a>
            ...
            @elseif(isset($courseNews))
                ...
                <tr class="bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                    <td class="px-6 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">          <a href="{{ route('course.news.show', [$courseId, $news->id]) }}">

                       {{ $news->title }}</a></td>
                    <td class="px-6 py-3"><a href="{{ route('course.news.show', [$courseId, $news->id]) }}">{{ $news->author->first_name }} {{ $news->author->last_name }}</a></td>
                    <td class="px-6 py-3">{{ $news->created_at->format('Y-m-d H:i') }}</td>
                    <td class="inline-flex px-6 py-3">

                        <a href="{{ route('course.news.edit', [$courseId, $news->id]) }}" class="font-medium text-blue-600 ms-3 dark:text-blue-500 hover:underline" title="Edit">
                            <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                <path fill-rule="evenodd" d="M5 8a4 4 0 1 1 7.796 1.263l-2.533 2.534A4 4 0 0 1 5 8Zm4.06 5H7a4 4 0 0 0-4 4v1a2 2 0 0 0 2 2h2.172a2.999 2.999 0 0 1-.114-1.588l.674-3.372a3 3 0 0 1 .82-1.533L9.06 13Zm9.032-5a2.907 2.907 0 0 0-2.056.852L9.967 14.92a1 1 0 0 0-.273.51l-.675 3.373a1 1 0 0 0 1.177 1.177l3.372-.675a1 1 0 0 0 .511-.273l6.07-6.07a2.91 2.91 0 0 0-.944-4.742A2.907 2.907 0 0 0 18.092 8Z" clip-rule="evenodd"/>
                            </svg>
                        </a>
