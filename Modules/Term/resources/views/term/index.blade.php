<x-term::layouts.master>
    <x-header headline="Terms">
        <x-slot:actions>
            @can('term.create')
            <x-button href="{{ route('term.create') }}" rounded="rounded-lg">
        ...
        <form method="GET" action="{{ route('term.index') }}"
            ...
            <div class="flex items-center gap-2">
                ...
                <div class="relative">
                    ...
                    <input type="text" id="term-search" name="query" value="{{ isset($query) ? e($query) : '' }}"
                ...
                @if(!empty($query))
                    <button name="query" value="" type="submit" onclick="{{ route('term.index') }}"
            ...
            <div class="flex space-x-5 items-center">
                <x-filter name="course" :options="$courses" :selected="$course" width="35" />
                <x-filter name="type" :options="$types" :selected="$type" width="35"/>
            </div>
