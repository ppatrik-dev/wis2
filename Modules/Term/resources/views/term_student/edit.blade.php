<x-term::layouts.master>
    <x-header headline="Edit Student Term">
        <x-slot:actions>
            ...
            <x-button href="{{ route('term.student.show', [$term, $student->id]) }}" variant="danger">
    ...
    <x-term::profile :student="$student">
        <form id="termStudentForm" action="{{ route('term.student.update', [$term, $student->id]) }}" method="POST"
